...
namespace BRAC_FORM
{
    public partial class Form3_PICATINNY : Form
    {
        public Form3_PICATINNY()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            CreateSeparateDetailDrawing($"Upper_brac_Picatinny_{GlobalVariables.bracketCounter}", 1);

            CreateSeparateDetailDrawing($"Lower_brac_Picatinny_{GlobalVariables.bracketCounter}", 2);
